...
const translations = {
  en: {
    ...
    'about-data-text':  'The investigations use numbers, maps and visualisations to report on housing, inequality and urban change in Portugal. They start from public data — INE, Pordata, Eurostat — and try to make visible what the raw figures only hint at.',
    'about-note':       'Personal work. Not affiliated with any publication.',
    // photography.html
  ...
  pt: {
    ...
    'about-data-text':  'As investigações usam números, mapas e visualizações para reportar sobre habitação, desigualdade e transformação urbana em Portugal. Partem de dados públicos — INE, Pordata, Eurostat — e tentam tornar visível o que os números brutos apenas insinuam.',
    'about-note':       'Trabalho pessoal. Sem afiliação com qualquer publicação.',
    // photography.html
