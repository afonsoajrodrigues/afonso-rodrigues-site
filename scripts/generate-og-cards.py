...
CARDS = [
    ...
    dict(slug="house-prices-vs-construction-costs", lang="en", icon="prices", title_size=42,
         ...
         title="Portugal’s house prices are rising twice as fast as the cost to build them"),
    dict(slug="house-prices-vs-construction-costs", lang="pt", icon="prices", title_size=38,
         kicker="Investigação · Relatório de Dados",
         title="Os preços da habitação em Portugal sobem ao dobro do ritmo do custo de construir"),
